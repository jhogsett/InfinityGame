...
#define HOUSE_BANK_WITHDRAWL (1000L / MONEY_BASIS)
#define PLAYER_LOAN (1000L / MONEY_BASIS)
#define BANK_MINIMUM (1000000L / MONEY_BASIS)
#define HOUSE_MINIMUM (1000L / MONEY_BASIS)
#define PLAYER_MINIMUM (0L / MONEY_BASIS)
#define GANG_MIMUMUM (1000L / MONEY_BASIS)
#define BANK_ROBBERY_MINIMUM (10000L / MONEY_BASIS)
#define BANK_ROBBERY_MAXIMUM (500000L / MONEY_BASIS)
#define HOUSE_BURGLARY_MINIMUM (5000L / MONEY_BASIS)
